	...
	if ( ! function_exists( 'sway_get_search_form' ) ) {
		function sway_get_search_form( $echo = true ) {
			...
			<label>
				...
				<input type="search" class="search-field" placeholder="' . apply_filters( 'sway_search_field_placeholder', esc_attr_x( 'جستجو . . .', 'placeholder', 'sway' ) ) . '" value="' . get_search_query() . '" name="s" />';
