...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> >
	...
	<div class="entry-wrapper <?php echo esc_attr($without_image_class); ?>">
		...
		<a class="tt_button tt_secondary_button btn_primary_color hover_solid_secondary post_button" href="<?php esc_url(the_permalink()); ?>"><span class="prim_text"><?php echo apply_filters( 'blog-readmore-text', esc_html__("ادامه مطلب", "sway") ); ?></span><span class="fa fa-chevron-right iconita"></span></a>
	</div>
</article>
